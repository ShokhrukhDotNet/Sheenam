...
namespace Sheenam.Api.Services.Foundations.HomeRequests
{
    public partial class HomeRequestService
    {
        ...
        private static void ValidateAgainstStorageHomeRequestOnModify(HomeRequest homeRequest, HomeRequest storageHomeRequest)
        {
            ValidateStorageHomeRequest(storageHomeRequest, homeRequest.Id);
